    ...
    def get(self, request, *args, **kwargs):
        ...
        if search:
            ...
            for date in news_list:
                date_news = []
                for new in date['news']:
                    if search in new['title']:
                        date_news.append(new)
                if date_news:
                    searched_date = {'created': date['created'], 'news': date_news}
                    searched_list.append(searched_date)
            news_list = searched_list
